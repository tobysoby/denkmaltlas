...
url = 'http://de.wikipedia.org/wiki/Vorlage:Navigationsleiste_Kulturdenkm%C3%A4ler_im_Landkreis_Bernkastel-Wittlich'
...
doc.css('.NavContent').css('a').each do |eintrag|
    ...
    CSV.open('Bernkastel-Wittlich/' + stadtteil + '.csv', 'a') do |csv|
