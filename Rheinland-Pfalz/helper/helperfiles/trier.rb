...
url = ['http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Kernstadt',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Biewer',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Ehrang/Quint',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Euren',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Feyen/Weismark',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Filsch',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Heiligkreuz',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Irsch',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Kernscheid',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-K%C3%BCrenz',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Mariahof',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Olewig',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Pfalzel',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Ruwer/Eitelsbach',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Tarforst',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Trier-Zewen']
...
url.each do |url_each|
    ...
    kreis.css('li').each do |denkmal|
        ...
        bezeichnungen_array.each_with_index do |vitamin, index|
            CSV.open('../ergebnisse/Trier_Stadt/' + stadtteil_array[index] + '.csv', 'a+') do |csv|
