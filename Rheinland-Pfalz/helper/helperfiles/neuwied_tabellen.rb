...
url = ['http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Windhagen',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Ockenfels'
    ]
...
url.each do |url|
    ...
    CSV.open('Neuwied/' + stadtteil + '.csv', 'a') do |csv|
