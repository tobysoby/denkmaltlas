...
url = [#'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_der_Kernstadt_von_Bad_Kreuznach/Denkmalzonen',
    ...
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Bad_M%C3%BCnster_am_Stein-Ebernburg',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Bosenheim',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Ippesheim_(Nahe)',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Planig',
    'http://de.wikipedia.org/wiki/Liste_der_Kulturdenkm%C3%A4ler_in_Winzenheim'
    ]
