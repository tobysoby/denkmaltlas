...
function geoJSONMarker (data) {
    ...
    function onEachFeature(feature, layer) {
        ...
        if (feature.properties.field_1) {
            marker = layer.bindPopup('<b>' + feature.properties.field_3 + '</b><br/><br/><a href="' + feature.properties.field_2 + '">' + feature.properties.field_1 + '</a><br/><br/>' +  feature.properties.field_5);
